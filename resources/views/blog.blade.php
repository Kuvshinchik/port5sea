                ...
                <div class="latest-blog-inner">
                    <div class="container">
                        <div class="section-header text-center">
                          <h2 class="section-heading primary-color">Мы в социальных сетях</h2>
                        </div>
                                    ...
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper">
                                            <div class="ratio" style="--bs-aspect-ratio: 177.77%;">
                                                <video controls>
                                                    <source src="{{asset('assets/img/video/01.mp4')}}" type="video/mp4">
                                                </video>
                                            </div>
                                            <span class="article-tag article-tag-absolute rounded">VK</span>
                                        </a>
                                        <p class="article-card-published text_12 d-flex align-items-center">
                                            <span class="article-date d-flex align-items-center">
												...
												<span class="ms-2">13 июля 2025</span>
                                            ...
                                            <span class="article-author d-flex align-items-center ms-4">
												...
												<span class="ms-2">Капитан Арктика</p>
                                        ...
                                        <h2 class="article-card-heading heading_18">
                                            <a class="heading_18" href="#">
                                                Презентация. 📚
                                                <br>
                                                Презентация морячков полосатиков.
                                            </a>
                                        </h2>
                                    </div>
                                </div>
								...
								<div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper">
                                            <div class="ratio" style="--bs-aspect-ratio: 177.77%;">
                                                <video controls>
                                                    <source src="{{asset('assets/img/video/02.mp4')}}" type="video/mp4">
                                                </video>
                                            </div>
                                            <span class="article-tag article-tag-absolute rounded">VK</span>
                                        </a>
                                        <p class="article-card-published text_12 d-flex align-items-center">
                                            <span class="article-date d-flex align-items-center">
												...
												<span class="ms-2">12 июня 2025</span>
                                ...
                                <div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                        <a class="article-card-img-wrapper">
                                            <div class="ratio" style="--bs-aspect-ratio: 177.77%;">
                                                <video controls>
                                                    <source src="{{asset('assets/img/video/03.mp4')}}" type="video/mp4">
                                                </video>
                                            </div>
                                            <span class="article-tag article-tag-absolute rounded">VK</span>
                                        </a>
                                        <p class="article-card-published text_12 d-flex align-items-center">
                                            <span class="article-date d-flex align-items-center">
                                                ...
                                                <span class="ms-2">8 июня 2025 года</span>
                                            </span>
                                            <span class="article-author d-flex align-items-center ms-4">
                                                <span class="icon-author"><svg width="15" height="17"
                                                        viewBox="0 0 15 17" fill="none"
                                                ...
                                                <span class="ms-2">Корабельный кок Макарони</span>
                                            </span>
                                        </p>
                                        <h2 class="article-card-heading heading_18">

											<a class="heading_18" href={{route('history')}} target="_blank">
                                                Про пингвинов 📚
                                                <br>
                                                Пингвин Макарони.
                                            </a>
								...
								<div class="article-slick-item" data-aos="fade-up" data-aos-duration="700">
                                    <div class="article-card bg-transparent p-0 shadow-none">
                                       {{-- <a class="article-card-img-wrapper" href="#">
                                            ...
                                            <span class="article-tag article-tag-absolute rounded">Telegram</span>
                                        </a>--}}
                                        <a class="article-card-img-wrapper">
                                            <div class="ratio" style="--bs-aspect-ratio: 177.77%;">
                                                <video controls>
                                                    <source src="{{asset('assets/img/video/04.mp4')}}" type="video/mp4">
                                                </video>
                                            </div>
                                            <span class="article-tag article-tag-absolute rounded">VK</span>
                                        </a>
                                        <p class="article-card-published text_12 d-flex align-items-center">
                                            <span class="article-date d-flex align-items-center">
                                                ...
                                                <span class="ms-2">2 мая 2025</span>
                                            </span>
                                            <span class="article-author d-flex align-items-center ms-4">
                                                <span class="icon-author"><svg width="15" height="17"
                                                        viewBox="0 0 15 17" fill="none"
