{{--
Этот раздел отрисовывает три карточки с фотографиями и наеэающими на них текстами
--}}
                ...
                <div class="collection-tab-inner mt-0">
                    <div class="container">
                        <div class="section-header text-center">
                            <h2 class="section-heading primary-color">Как цифровой друг общается с вашим ребенком.</h2>
                        </div>
                        <div class="shop-category-2 shop-category-inner">
                            <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                                <div class="scattered-wrapper">
                                    ...
                                    <div class="scattered-details">
                                        <h2 class="scattered-heading primary-color">Игры и развлечения</h2>
                                        <a href="collection-left-sidebar.html"
                                            class="text_12 link-underline d-block primary-color mt-2">
                                            Давай поиграем вместе!<br>Загадки, викторины и веселые задания.
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="scattered-item" data-aos="fade-right" data-aos-duration="700">
                                <div class="scattered-wrapper">
                                    ...
                                    <div class="scattered-details">
                                        <h2 class="scattered-heading primary-color">Обучение и развитие</h2>
                                        <a href="#2" class="text_12 link-underline d-block primary-color mt-2">
                                            Учимся легко! Новые знания в форме сказок и экспериментов.
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="scattered-item" data-aos="fade-left" data-aos-duration="700">
                                <div class="scattered-wrapper">
                                    ...
                                    <div class="scattered-details">
                                        <h2 class="scattered-heading primary-color">Дружеские беседы</h2>
                                        <a href="#3" class="text_12 link-underline d-block primary-color mt-2">
                                            Расскажи мне всё – я всегда поддержу!
                                        </a>
                                    </div>
                                </div>
                            </div>
