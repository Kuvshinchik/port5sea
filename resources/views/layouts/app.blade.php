...
<head>
    <!-- Вставьте весь <head> из index.blade.php -->
    ...
    <!-- Добавьте ссылки на app.css и app.js от Bootstrap  -->
...
<body>
                        ...
                        <div class="col-lg-3 col-md-4 col-4">
                            <div class="header-logo">
                                <a href="{{ route('index') }}" class="logo-main">
                                    <img src="{{asset('assets/img/logo.png')}}" loading="lazy" alt="MAISON MARINE">
                                </a>
                            </div>
                        </div>
                        <div id="begin" class="col-lg-9 d-lg-block d-none" >
							...
							@if ( auth()->user() )
								<li class="menu-list-item nav-item">
									...
									<li class="menu-list-item nav-item">
                                        <a href="{{ route('fortune.wheel') }}" class="nav-link">Колесо</a>
    ...
    <main id="MainContent" class="content-for-layout mt-48">
        @yield('content')  <!-- Здесь будет вставляться контент страниц -->
    </main>

    

        <!-- footer start -->
        <footer class="mt-100 overflow-hidden footer-style-2" id="contact">
            <div class="footer-top bg-6">
                <div class="container">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        <li class="footer-menu-item"><a href="about-us.html">Наша платформа — это инновационный продукт, созданный в тесном сотрудничестве с дизайнером оригинальных мягких игрушек, чьи прототипы защищены авторским правом.<br>Мы предлагаем уникальное сочетание физических игрушек и цифровых технологий, которое превращает традиционные игрушки в интерактивных AI-компаньонов для детей.
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="/"><img src="{{asset('assets/img/logo-accent.png')}}" alt="bisum"></a>
                                    </h4>
                                    <div class="footer-newsletter">
                                        <p class="footer-text mb-3">Техподдержка.</p>
										<p class="footer-text mb-3">laravelbot@laravelbot.ru</p>
                                        {{--
										<div class="newsletter-wrapper">
                                            <form action="#" class="footer-newsletter-form d-flex align-items-center">
                                                <input class="footer-newsletter-input bg-transparent" type="email"
                                                    placeholder="Ваш e-mail" autocomplete="off">
                                                <button class="footer-newsletter-btn" type="submit">Отправить</button>
                                            </form>
                                        </div>
										--}}
										{{--
                ...
                <div class="container">
                    <div
                        ...
                        <ul class="footer-bottom-menu list-unstyled d-flex flex-wrap align-items-center mb-0">
                            <li class="footer-menu-item"><a href="about-us.html">
							
							
							</a></li>
                        </ul>

                        <p class="copyright footer-text">©<span class="current-year"></span> LaravelBot.</p>
    ...
    <script src="{{ mix('js/app.js') }}"></script>  <!-- Для Bootstrap JS -->
    <!-- Ваш скрипт для carousel -->
    <script>
