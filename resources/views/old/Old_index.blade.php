    ...
    <nav class="navbar navbar-expand-lg fixed-top site-navigation white">
        <div class="container">
            <a class="navbar-brand page-scroll" href="#">
                    <img src="{{asset('assets/img/logo-w.png')}}" alt="Bensen" class="img-fluid white-logo">
                    <img src="{{asset('assets/img/logo-b.png')}}" alt="Bensen" class="img-fluid black-logo">
                </a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 d-sm-none d-lg-block">
                    <div class="banner-img banner-padding">
                        <img src="{{asset('assets/img/banner/item-06.png')}}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="feature-box">
                        <img src="{{asset('assets/img/about/feature-1.png')}}" alt="" class="img-fluid">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="feature-box">
                        <img src="{{asset('assets/img/about/feature-2.png')}}" alt="" class="img-fluid">
                        <div class="feature-content">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="feature-box">
                        <img src="{{asset('assets/img/about/feature-3.jpg')}}" alt="" class="img-fluid">
                        <div class="feature-content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-7 offset-lg-1 col-md-6">
                    <div class="video-bg">
                        <img src="{{asset('assets/img/video-bg.jpg')}}" alt="" class="img-fluid">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-4">
                    <div class="footer-logo">
                        <img src="{{asset('assets/img/logo-w.png')}}" alt="Footer logo" class="img-fluid">
                    </div>
                </div>
