            ...
            <div class="slideshow-section position-relative">
                <div class="slideshow-active activate-slider" data-slick='{
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="assets/img/products/furniture/1.jpg" alt="slide-1">
                        <img class="slide-img d-md-none" src="assets/img/products/furniture/1.jpg" alt="slide-1">
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="assets/img/products/furniture/3.jpg" alt="slide-2">
                        <img class="slide-img d-md-none" src="assets/img/products/furniture/3.jpg" alt="slide-2">
                        <div class="content-absolute content-slide">
                            <div class="container height-inherit d-flex align-items-center justify-content-end">
                    ...
                    <div class="slide-item slide-item-bag position-relative">
                        <img class="slide-img d-none d-md-block" src="assets/img/products/furniture/9.jpg" alt="slide-3">
                        <img class="slide-img d-md-none" src="assets/img/products/furniture/9.jpg" alt="slide-3">
                        <div class="content-absolute content-slide">
