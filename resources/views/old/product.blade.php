                                ...
                                <div class="product-img-large">
                                    <div class="img-large-slider common-slider" data-slick='{
                                        ...
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/39.jpg')}}" data-fancybox="gallery">
                                                <img src="{{asset('assets/img/products/bags/39.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/38.jpg')}}" data-fancybox="gallery">
                                                <img src="{{asset('assets/img/products/bags/38.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/37.jpg')}}" data-fancybox="gallery">
                                                <img src="{{asset('assets/img/products/bags/37.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/36.jpg')}}" data-fancybox="gallery">
                                                <img src="{{asset('assets/img/products/bags/36.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/34.jpg')}}" data-fancybox="gallery">
                                                <img src="{{asset('assets/img/products/bags/34.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/30.jpg')}}" data-fancybox="gallery">
                                                <img src="{{asset('assets/img/products/bags/30.jpg')}}" alt="img">
                                            </a>
                                        </div>
                                        <div class="img-large-wrapper">
                                            <a href="{{asset('assets/img/products/bags/32.jpg')}}" data-fancybox="gallery">
                        ...
                        <div id="pdescription" class="tab-pane fade show active">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-12 col-12">
                                    <div class="desc-img">
                                        <img src="{{asset('assets/img/product.jpg')}}" alt="img">
                                    </div>
                                </div>
                ...
                <div class="container">
                        ...
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/11.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/1.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/22.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/2.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/23.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/3.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/26.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/4.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/27.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/5.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/29.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/6.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/17.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/7.jpg')}}"
                                        alt="product-img">
                                </a>
                    ...
                    <div class="new-item" data-aos="fade-up" data-aos-duration="300">
                        <div class="product-card">
                            <div class="product-card-img">
                                <a class="hover-switch" href="collection-left-sidebar.html">
                                    <img class="secondary-img" src="{{asset('assets/img/products/bags/18.jpg')}}"
                                        alt="product-img">
                                    <img class="primary-img" src="{{asset('assets/img/products/bags/8.jpg')}}"
                                        alt="product-img">
                                </a>
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="/"><img src="{{asset('assets/img/logo-white.png')}}" alt="bisum"></a>
                                    </h4>
